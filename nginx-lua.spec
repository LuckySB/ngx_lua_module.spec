...
Source12: COPYRIGHT
Source100: ngx_devel_kit-0.2.19.tar.gz
Source101: lua-nginx-module-0.10.1rc1.tar.gz
...
./configure \
        ...
        --add-dynamic-module=%{_builddir}/nginx-%{version}/lua-nginx-module-0.10.1rc1 \
        --with-threads \
        --with-stream=dynamic \
...
%{__install} -m 755 -p objs/ngx_http_lua_module.so $RPM_BUILD_ROOT%{_libdir}/nginx/modules
...
%changelog
* Thu Feb 18 01:18:55 MSK 2016 Sergey Bondarev <s.bondarev@southbridge.ru>
- add build with dynamic module
- add dynamic lua module 
